...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    const { friend_id, title, status, pct, hours_played, hltb_main, hltb_extra, hltb_complete, cover_url, description, genres, started_at, last_played_at, finished_at, no_progress } = req.body
